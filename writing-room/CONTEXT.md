...
- **Don't treat `voice.md` as an internal document.** `community/` pulls it cross-workspace for all newsletter and social content. Changes to `voice.md` affect community output. Update it as a shared resource, not an internal style note.
