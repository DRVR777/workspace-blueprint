...
3. Run `{root}/_meta/spec-review.md` on `programs/api/` first (no dependencies)
4. On PASS: move api to `specced`, begin build
5. Run `{root}/_meta/spec-review.md` on `programs/frontend/` after api contracts are defined
