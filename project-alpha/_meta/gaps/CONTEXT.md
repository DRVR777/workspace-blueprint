# Gap Registry — project-alpha (scope: project-alpha)
...
2. Run gap detection agent with `scope: project-alpha`
3. Gap objects created here for internal gaps
4. Cross-project gaps escalated to root `_meta/gaps/` automatically

## Escalation Rule
If a gap involves any folder outside `project-alpha/` — it is a root-scope gap.
